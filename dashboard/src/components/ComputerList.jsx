...
import { Monitor, Wifi, WifiOff, Clock, User, HardDrive } from 'lucide-react';
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-500">
            {computers.filter(c => c.is_online).length} online of {computers.length} total
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="p-5">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex items-center gap-2 text-gray-400">
                  ...
                  <span>{computer.os_version || 'Windows'}</span>
                </div>
                <div className="flex items-center gap-2 text-gray-400">
                  <Clock className="w-4 h-4" />
                  <span>
                    {computer.last_seen 
                      ? `Last seen ${formatDistanceToNow(new Date(computer.last_seen), { addSuffix: true })}`
                      : 'Never connected'
                    }
                  </span>
                </div>
        ...
        {computers.length === 0 && (
          <div className="col-span-full text-center py-12">
            ...
            <h3 className="text-lg font-medium text-gray-400">No computers registered</h3>
